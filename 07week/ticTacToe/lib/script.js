...
class TicTacToe extends React.Component {
  ...
  handleClick(cellIndex) {
    if (document.querySelector('div[data-cell="' + cellIndex + '"]').className.startsWith('taken')) {
      return;
    }
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement('div', { 'data-cell': '0', className: 'square type-X', onClick: () => this.handleClick(0) }),
        React.createElement('div', { 'data-cell': '1', className: 'square type-X', onClick: () => this.handleClick(1) }),
        React.createElement('div', { 'data-cell': '2', className: 'square type-X', onClick: () => this.handleClick(2) })
      ),
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement('div', { 'data-cell': '3', className: 'square type-X', onClick: () => this.handleClick(3) }),
        React.createElement('div', { 'data-cell': '4', className: 'square type-X', onClick: () => this.handleClick(4) }),
        React.createElement('div', { 'data-cell': '5', className: 'square type-X', onClick: () => this.handleClick(5) })
      ),
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement('div', { 'data-cell': '6', className: 'square type-X', onClick: () => this.handleClick(6) }),
        React.createElement('div', { 'data-cell': '7', className: 'square type-X', onClick: () => this.handleClick(7) }),
        React.createElement('div', { 'data-cell': '8', className: 'square type-X', onClick: () => this.handleClick(8) })
      )
    );
  }
}
